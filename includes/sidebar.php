...
<div id="sidebar-menu">
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <?php if ($is_seller): ?>
        <li>
            <a href="pos3.php"><i class="bx bx-cart-add"></i> <span class="badge bg-success float-end">LIVE</span> <span>POS Billing</span></a>
        </li>
        <?php endif; ?>
...
<li>
    <a href="javascript: void(0);" class="has-arrow">
        <i class="bx bx-wallet"></i> <span>Expenses</span>
    </a>
    <ul class="sub-menu">
...
<li>
    <a href="javascript: void(0);" class="has-arrow">
        <i class="bx bx-share-alt"></i> <span>Referrals</span>
    </a>
    <ul class="sub-menu">
...
<li>
    <a href="javascript: void(0);" class="has-arrow">
        <i class="bx bx-building-house"></i> <span>Construction</span>
    </a>
    <ul class="sub-menu">
        <li><a href="engineers.php">Engineer</a></li>
